...
// Etapa 2 do teste no sandbox: Pix na conta da plataforma (sem split), pago na hora.
// Uso: tsx scripts/asaas-sandbox-pay.ts
...
async function main() {
  const charge = await provider.createPixCharge({
    ...
    description: "Teste de repasse por transferência",
  });
