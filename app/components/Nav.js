    ...
    <>
      ...
      <nav style={{background:'var(--bg)',borderBottom:'1px solid var(--border)',padding:'0 32px',height:'64px',display:'flex',alignItems:'center',justifyContent:'space-between',position:'sticky',top:0,zIndex:100}}>
        ...
        <div style={{display:'flex',alignItems:'center',gap:'32px'}}>
          ...
          <a href="https://chat.whatsapp.com/DylGoK7gscc9e4wJkqxspx" target="_blank" style={{background:'var(--pink)',color:'#fff',padding:'9px 20px',borderRadius:'6px',fontSize:'13px',fontWeight:500}}>Grupo VIP</a>
        </div>
      </nav>
    </>
  )
