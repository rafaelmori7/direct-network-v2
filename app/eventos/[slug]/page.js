          ...
          <div className="detail-grid">
            ...
            <div style={{display:'flex',flexDirection:'column',gap:'20px',paddingTop:'4px'}}>
              ...
              <div style={{display:'flex',flexDirection:'column',gap:'10px'}}>
                ...
                {f.linkPix && (
                  <a href={f.linkPix} target="_blank" style={{display:'flex',alignItems:'center',justifyContent:'center',gap:'8px',width:'100%',background:'transparent',color:'#32BCAD',border:'1px solid #32BCAD',fontFamily:'var(--font-display)',fontSize:'14px',fontWeight:600,padding:'14px',borderRadius:'8px'}}>
                    <svg width="18" height="18" viewBox="0 0 24 24" fill="#32BCAD"><path d="M16.67 14.12l-2.55-2.55c-.22-.22-.51-.34-.81-.34s-.59.12-.81.34l-2.55 2.55c-.45.45-1.04.69-1.67.69s-1.22-.24-1.67-.69L4.1 11.4a2.36 2.36 0 0 1 0-3.34l2.42-2.42c.45-.45 1.04-.69 1.67-.69s1.22.24 1.67.69l1.07 1.07c.34.34.89.34 1.23 0 .34-.34.34-.89 0-1.23L11.09 4.4a3.97 3.97 0 0 0-2.9-1.19c-1.09 0-2.12.43-2.9 1.19L2.87 6.82a4.1 4.1 0 0 0 0 5.79l2.42 2.42a3.97 3.97 0 0 0 2.9 1.19c1.09 0 2.12-.43 2.9-1.19l2.55-2.55c.22-.22.51-.34.81-.34s.59.12.81.34l2.55 2.55c.45.45 1.04.69 1.67.69s1.22-.24 1.67-.69l2.42-2.42a4.1 4.1 0 0 0 0-5.79l-1.07-1.07c-.34-.34-.89-.34-1.23 0-.34.34-.34.89 0 1.23l1.07 1.07c.92.92.92 2.42 0 3.34l-2.42 2.42c-.45.45-1.04.69-1.67.69s-1.22-.24-1.67-.69z"/></svg>
