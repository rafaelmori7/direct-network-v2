...
// TTL do cache de dados entre requests. Frescor de verdade em produção vem
// do webhook do Contentful chamando revalidateTag() em /api/revalidate —
// uma edição publicada aparece no site na próxima visita, independente
// deste valor. Isto aqui é só a rede de segurança pro que passar batido
// pelo webhook (ou pra tráfego entre uma publicação e outra), então o
// custo de alongar é baixo. Alongado de 300s pra 3600s em 07/09/2026,
// junto com o fix de dedup por request (ver comentário abaixo) — a cota
// mensal do Contentful estava em 78% aos 23 dias de um ciclo de 30.
